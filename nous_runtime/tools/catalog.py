...
def _runtime_metadata(tool_id: str) -> dict[str, Any]:
    explicit = {
        ...
        "patch_file": ("files", "filesystem.write", "write"),
        "make_directory": ("files", "filesystem.write", "write"),
        "move_path": ("files", "filesystem.write", "write"),
        "remove_path": ("files", "filesystem.write", "write"),
        "run_command": ("shell", "process.execute", "execute"),
        "shell_start": ("shell", "process.session.start", "execute"),
        "shell_status": ("shell", "process.session.read", "read"),
        "shell_attach": ("shell", "process.session.read", "read"),
        "shell_detach": ("shell", "process.session.read", "read"),
        "shell_stdout": ("shell", "process.session.read", "read"),
        "shell_stderr": ("shell", "process.session.read", "read"),
        "shell_stdin": ("shell", "process.session.control", "execute"),
        "shell_close_stdin": ("shell", "process.session.control", "execute"),
        "shell_interrupt": ("shell", "process.session.control", "execute"),
        "shell_terminate": ("shell", "process.session.control", "execute"),
        "shell_kill": ("shell", "process.session.control", "execute"),
        "shell_recover": ("shell", "process.session.recover", "read"),
